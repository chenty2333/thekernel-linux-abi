...
- sticky-directory and SGID/umask create policy; and
- an RAII mutation transaction that revalidates before one publication and
  rolls every prepared failure back.
...
- `DacError::StickyDenied` to `EPERM`.
